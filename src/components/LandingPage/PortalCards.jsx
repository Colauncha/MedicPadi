...
const PORTALS = [
  {
    ...
    to: "/doctor-signup",
    gradient:
      "linear-gradient(307.35deg, #150D5E 4.51%, #150D5E 49.96%, #2C1BC4 98.62%)",
  },
  {
    label: "Lab Portal",
    ...
    gradient: "linear-gradient(310.43deg, #382A4B 55.08%, #8463B1 98.78%)",
  },
  {
    ...
    to: "/pharmacy-signup",
    gradient: "linear-gradient(317.21deg, #684E89 5.29%, #150D5E 55.95%)",
  },
];
        ...
        <div className="grid lg:grid-cols-3 gap-6 mb-10">
          {PORTALS.map((portal) => (
            <div
              ...
              className="flex flex-col justify-between p-8 rounded-2xl text-white min-h-[280px]"
            >
              <div>
              ...
              <Link
                to={portal.to}
                className="inline-flex items-center gap-2 text-sm font-medium mt-8 pt-4 border-t border-white/80 hover:text-white/95 transition-colors"
              >
                {portal.cta}
