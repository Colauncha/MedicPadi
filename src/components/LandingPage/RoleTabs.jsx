...
//       "Keep your full health history in one secure record",
//     ],
//     cta: { label: "Download App", to: "#download-app" },
//   },
...
//     // Check the hash whenever it changes
...
//     <section
//       id="role-tabs"
//       className="mx-auto px-8 lg:px-10 py-20 bg-[#F1EFF8]"
//     >
...
//           labs, and pharmacies get a web portal built for volume — every action
//           updates the same record in real time.
//         </p>
//       </div>
