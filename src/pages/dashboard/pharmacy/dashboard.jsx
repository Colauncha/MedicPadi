      ...
      <div className="flex flex-col gap-8 pb-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {stats.map((stat, i) => (
            ...
            >
              <div>
                <p className="text-[#7C7A9E] text-[15px] font-medium mb-1">
                  {stat.title}
                </p>
                <h3 className="text-[#150D5E] text-3xl font-bold mb-2">
                  {stat.value}
                </h3>
        ...
        <div className="bg-white border border-[#eef0f6] rounded-2xl p-6">
          <h2 className="text-lg font-bold text-[#150D5E] mb-6">
          ...
          <div className="flex items-stretch h-[280px]">
            ...
            <div className="flex-1 flex justify-between items-end border-l border-b border-[#EEF0F6] pb-2 pl-4 pr-2">
              {chartData.map((data, index) => (
                <div
                  key={index}
                  className="flex flex-col items-center flex-1 h-full max-w-[54px] justify-end group"
                >
                  {/* Bar Capsule */}
                  <div
                    className={`w-full ${data.height} ${data.bg} rounded-full transition-all duration-500 hover:brightness-95 cursor-pointer relative overflow-hidden flex flex-col justify-between py-4`}
                  >
                    ...
                    <div className="flex flex-col items-center justify-center flex-1 select-none pointer-events-none">
                      <div className="flex flex-col items-center gap-0.5 [writing-mode:vertical-lr] rotate-180 text-[#150D5E] whitespace-nowrap">
                        <span className="font-bold text-[11px] leading-none uppercase tracking-wider">
                          Ibuprofen
                        </span>
                        <span className="text-[9px] opacity-75 font-medium leading-none">
                          Antibiotics
                        </span>
                      </div>
                    </div>
                  ...
                  {/* Month Label */}
                  <span className="text-xs font-semibold text-[#7C7A9E] mt-3">
                    {data.month}
                  </span>
                </div>
              ))}
          ...
          <div className="lg:col-span-2 bg-white border border-[#eef0f6] rounded-2xl p-6 flex flex-col justify-between">
            <div>
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
                <h2 className="text-xl font-bold text-[#150D5E]">
                  Latest Orders
                </h2>
                    ...
                    {filteredOrders.length > 0 ? (
                      filteredOrders.map((order, i) => (
                        ...
                        >
                          ...
                          <td className="py-4 px-4 font-bold text-[#150D5E]">
                            {order.price}
                          </td>
                        </tr>
                      ))
          ...
          <div className="bg-gradient-to-br from-[#150D5E] via-[#241A8C] to-[#3B2FB3] text-white p-6 rounded-2xl flex flex-col justify-between relative overflow-hidden group min-h-[300px]">
            ...
            <div className="relative flex justify-between items-start gap-4">
              <div className="flex flex-col gap-1.5 z-10">
                ...
                <h3 className="text-4xl font-extrabold text-[#FFF3D6] tracking-tight">
                  20% off
                </h3>
                <p className="text-sm font-medium opacity-90 mt-1 max-w-[130px]">
                  on children medicine
                </p>
              ...
              <div className="z-10 shrink-0 transform hover:scale-105 transition-transform duration-300">
                <svg
                  viewBox="0 0 120 120"
                  className="w-28 h-28 filter drop-shadow-xl"
                >
