                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-[10px] text-[#454545] mt-0.5">
                        02:00 PM
                      </p>
                    </div>
                  </div>
            ...
            <div className="flex-1 p-6 overflow-y-auto">
              ...
              <div>
                ...
                <p className="text-[13px] text-gray-500 pl-[42px] leading-relaxed">
                  Brain problems can manifest in various ways, and symptoms may
                  include headaches, memory issues, changes in mood or behavior,
                  difficulty concentrating, or physical coordination problems...
                </p>
